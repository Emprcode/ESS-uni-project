...
export const Privacy = () => {
  return (
    <div class="row input-wrapper" id="privacy-wrapper">
      <a href="/settings" class="privacy-back">
        &#8249; BACK
      </a>
      <h1 className="privacy-title"> Setting </h1>
      ...
      support services,job, food, and shelter. Every day, we connect millions of
      ...
      <ul>
        <li>By mail: 154-158 Sussex St, Sydney NSW 2000</li>
      </ul>
      <li> OR</li>
      <body>
